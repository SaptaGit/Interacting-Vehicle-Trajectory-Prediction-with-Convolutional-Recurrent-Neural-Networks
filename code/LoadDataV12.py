...
imageFolder = '/home/saptarshi/PythonCode/AdvanceLSTM/vehicle/'
...
trainingCsvFile = '/home/saptarshi/PythonCode/AdvanceLSTM/SplittedData/vehicle4.csv'
...
def generateOccupancyGrid(vehiclePositions):
    ...
    imageCount = 0
    laneWidthFeet = 14
    horizontaLimit = 55 #(2 car length 10*2=20 feet and gaps 5*2=10)
