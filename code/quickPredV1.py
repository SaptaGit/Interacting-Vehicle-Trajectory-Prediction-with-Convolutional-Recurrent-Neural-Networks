...
testFolder = '/home/saptarshi/PythonCode/AdvanceLSTM/SuperDuperhigh/'

#trajImageFolder = '/home/saptarshi/PythonCode/AdvanceLSTM/traj1445secImage/'
...
if __name__ == '__main__':
    ...
    trainModel = load_model('/home/saptarshi/PythonCode/AdvanceLSTM/superDuperHighRes16384.h5', custom_objects={'euclidean_distance_loss': euclidean_distance_loss})
    # encoder_model = load_model('/home/saptarshi/PythonCode/AdvanceLSTM/encoder.h5') if bad try trajStateEncodeBadNewData1
    ...
    for eachFolder in testFolderList:
        ...
        for t in range(predTemporal):
            # predict next pose
            yhat1 = trainModel.predict(inputTestArray)
            # store prediction
