...
trainFolder = '/home/saptarshi/PythonCode/AdvanceLSTM/retrain/'
...
if __name__ == '__main__':
    ...
    model = load_model('/home/saptarshi/PythonCode/AdvanceLSTM/quick.h5', custom_objects={'euclidean_distance_loss': euclidean_distance_loss})

    f = open('/home/saptarshi/PythonCode/AdvanceLSTM/retrain/609/output.txt', 'r')
    ...
    check = model.predict(inputTestArray)
    ...
    history = model.fit_generator(trainGen, steps_per_epoch=stepsPerEpoch, epochs=20, verbose=1)

    model.save('requick.h5')
