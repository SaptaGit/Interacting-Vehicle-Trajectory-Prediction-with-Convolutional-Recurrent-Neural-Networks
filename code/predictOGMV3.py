...
modelFilePath = '/home/saptarshi/PythonCode/AdvanceLSTMServer/TrainedModels/ConcatLeakyforLSTM.h5'
            ...
            if ( len(trackerDict[primaryCarId]) == outputSize):
                ...
                for t in range(1,31):
                    ...
                    if predictedPoseY > OccupancyImageHeight/2:
                        predictedPoseY = (OccupancyImageHeight/2) - 2
