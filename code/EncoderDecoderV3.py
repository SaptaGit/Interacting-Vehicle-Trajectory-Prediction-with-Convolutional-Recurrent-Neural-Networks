...
if __name__ == '__main__':
    ...
    ConvPart2 = ConvLSTM2D(
        ...
        return_sequences=True)(ConvPart2)
    ConvPart2 = TimeDistributed(BatchNormalization())(ConvPart2)
    #ConvPart2 = TimeDistributed(MaxPooling2D(pool_size=(9,9)))(ConvPart2)
    ...
    trajEncoded = LSTM(56, activation='relu', return_sequences=True)(trajEncoded)

    multipleSoftmax = RepeatVector(temporal)(ManeuverClass)

    concatinatedSoftmax = concatenate([trajEncoded, multipleSoftmax])
    ...
    Decoded = LSTM(256, activation='relu', return_sequences=True)(concatinatedSoftmax)
    #ConvPart1 = TimeDistributed(BatchNormalization())(ConvPart1)
