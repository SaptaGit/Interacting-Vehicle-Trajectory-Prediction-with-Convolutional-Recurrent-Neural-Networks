...
imageFolder = '/home/saptarshi/PythonCode/AdvanceLSTM/long/'
...
trainingCsvFile = '/home/saptarshi/PythonCode/AdvanceLSTM/SplittedData/maptest1.csv'
    ...
    for vehicle in vehiclePositions:
        ...
        for idx, _ in enumerate(vehicle):
            ...
            for sampleFrame in inputSampleFrames:
                ...
                #cv2.rectangle(currentFrame, (int(100), int(100)), (int(500),int(1000)), (255,0,0), 4)
                if DrawCount%10 == 0:
                    cv2.rectangle(currentFrame, (int(relativeTargetX-pixelWidth), int(relativeTargetY)), (int(relativeTargetX+pixelWidth), int(relativeTargetY+pixelLength)), (255,0,0), 16)
                #currentFrame[int(relativeTargetY):int(relativeTargetY+pixelLength),int(relativeTargetX-pixelWidth):int(relativeTargetX+pixelWidth),0] = 0
                #currentFrame[int(relativeTargetY):int(relativeTargetY+pixelLength),int(relativeTargetX-pixelWidth):int(relativeTargetX+pixelWidth),1] = 0
                ...
                for jdx in range(2,frameLength):
                    ...
                    if (localTime == OtherLocalTime):
                        ...
                        if DrawCount%10 == 0:
                            cv2.rectangle(currentFrame, (int(absoluteXPixel-pixelWidth),int(absoluteYPixel)), (int(absoluteXPixel+pixelWidth),int(absoluteYPixel+pixelLength)), (0,0,255), 16)
                        #currentFrame[int(absoluteYPixel):int(absoluteYPixel+pixelLength),int(absoluteXPixel-pixelWidth):int(absoluteXPixel+pixelWidth),1] = 0
                        #currentFrame[int(absoluteYPixel):int(absoluteYPixel+pixelLength),int(absoluteXPixel-pixelWidth):int(absoluteXPixel+pixelWidth),2] = 0
