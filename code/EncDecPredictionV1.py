...
if __name__ == '__main__':
    ...
    f = open('/home/saptarshi/PythonCode/AdvanceLSTM/Vehicle11/379/output.txt', 'r')
    ...
    for t in range(30):
        ...
        inputTestArray[:,-1,:] = np.array([yhat1[0][0][0][0]/OccupancyImageWidth, yhat1[0][0][0][1]/OccupancyImageHeight])
        for pdx in range(0,20):
    ...
    modifiedLonError = FrameLonError(outputTrajArray,resultModified)

    print(modifiedLonError)

    #plt.plot(originalLonError, label='Original')
    plt.plot(modifiedLonError, label='Modified')
    plt.legend()
    plt.show()
