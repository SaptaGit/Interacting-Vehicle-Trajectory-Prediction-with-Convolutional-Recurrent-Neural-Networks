...
from keras.layers import LSTM, Dense, TimeDistributed, Conv2D, MaxPooling2D, Flatten, Dropout, MaxPooling1D, MaxoutDense, ConvLSTM2D, BatchNormalization, AveragePooling3D
...
if __name__ == '__main__':
    ...
    model.add(TimeDistributed(MaxPooling2D(pool_size=(9,9))))
    model.add(ConvLSTM2D(
        filters=5,
        kernel_size=(5, 5),
        activation='relu',
