...
testTrajFilePath = '/home/saptarshi/PythonCode/AdvanceLSTM/SplittedData/us101-0750am-0805am.csv' 
# Load the pre trained model
modelFilePath = '/home/saptarshi/PythonCode/AdvanceLSTM/TrainVal.h5'
        ...
        for idx, _ in enumerate(vehicle):
            ...
            if ( len(trackerDict[primaryCarId]) == outputSize):
                ...
                for t in range(1,predTemporal+1):
                    ...
                    # Collect the Next frame prediction
                    predictedPoseX =  predictedPrimayPoses[0][0][0]
                    predictedPoseY =  predictedPrimayPoses[0][0][1]
