...
resultFolder = '/home/saptarshi/PythonCode/AdvanceLSTM/Results/Check1/'
...
LaneChangeVehicleList = [9.0,41.0,7.0,5.0,26.0,37.0,44.0,54.0,58.0,41.0,31.0,15.0,32.0,45.0,141.0,148.0]
    ...
    for vehicle in relativePositionList:
        ...
        for idx, _ in enumerate(vehicle):
            ...
            if ( len(trackerDict[primaryCarId]) == outputSize):
                ...
                # Draw lane markings
                cv2.line(opencvVisulaizeImage,(58,0),(58,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(68,0),(68,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(78,0),(78,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(88,0),(88,510),(255,0,0),1)
            ...
            if ( len(trackerDict[primaryCarId]) == outputSize):
                ...
                for t in range(1,predTemporal+1):
                    ...
                    if not targetCarPredictedPoses:
                        ...
                        lastPredX = targetCarPredictedPoses[-1][0]
                        lastPredY = targetCarPredictedPoses[-1][1]
                        newPredX = lastPredX -  3.5*shiftX  #Something weird check   - shiftX
                        newPredY = lastPredY - shiftY
                        targetCarPredictedPoses.append([newPredX,newPredY])
                ...
                # Draw lane markings
                # cv2.line(opencvVisulaizeImage,(33,0),(33,510),(255,0,0),1)
                # cv2.line(opencvVisulaizeImage,(45,0),(45,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(58,0),(58,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(70,0),(70,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(82,0),(82,510),(255,0,0),1)
                #cv2.line(opencvVisulaizeImage,(88,0),(88,510),(255,0,0),1)
                cv2.line(opencvVisulaizeImage,(95,0),(95,510),(255,0,0),1)
