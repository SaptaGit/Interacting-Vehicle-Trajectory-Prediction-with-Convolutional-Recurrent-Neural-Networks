...
class CIFAR10Sequence(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        decoderInputTraj = np.array(decoderInputTraj).reshape(self.batch_size, temporal, 2)  # Decoder Input Trajectory (Shifted from the output)
...
if __name__ == '__main__':
    ...
    trainModel.fit_generator(trainGen, steps_per_epoch=stepsPerEpoch, epochs=2000, verbose=1, callbacks=callbacks_list)
    ...
    trainModel.save('./trainmodellong.h5')
    encoder_model.save('./encoderlong.h5')
    decoder_model.save('./decodelongr.h5')
